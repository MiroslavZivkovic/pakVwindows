...
!         if(nbrel.eq.41923)  WRITE(3,*) "nbrel,FK1TOK",nbrel,FK1TOK
!         if(nbrel.eq.19663)  WRITE(3,*) "nbrel,FK1TOK",nbrel,FK1TOK
!         if(nbrel.eq.4808)  WRITE(3,*) "nbrel,FK1TOK",nbrel,FK1TOK
